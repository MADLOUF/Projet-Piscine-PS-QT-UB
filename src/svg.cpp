...
{
    /*
    std::cout << "Ouverture du fichier svg : "
              << m_filename << std::endl;
    */
...
/// https://developer.mozilla.org/fr/docs/Web/SVG/Tutoriel/Formes_de_base
void Svgfile::addRect(double x, double y, int width, int height, std::string color, std::string border)
{
     m_ostrm << "<rect "
               << attrib("x", x)
               << attrib("y", y)
